          ...
          {timedAbilities.map((ability, index) => {
            ...
            return (
              <button
                ...
                className={`w-20 h-20 rounded-xl border-2 transition-all duration-200 relative overflow-hidden shadow-lg ${
                  ability.cooldown > 0
              ...
              >
                <div className="flex flex-col items-center justify-center h-full relative z-10">
                  ...
                  <span className="text-xs text-gray-200 leading-tight font-medium mt-1">
