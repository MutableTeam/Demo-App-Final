...
export function CyberpunkFooter({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-0 left-0 right-0 z-10 flex justify-between items-center p-4 bg-black/20 backdrop-blur-sm",
        className,
      )}
    >
      <div className="flex items-center">
        <span
          className={cn(
            ...
            isCyberpunk
              ? "text-cyan-300 border-cyan-400/50 bg-black/60"
              : "text-foreground border-primary/50 bg-background/80",
          )}
        >
          Demo-Build
        </span>
