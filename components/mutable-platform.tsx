    ...
    <div className="space-y-4 w-full">
      <Tabs defaultValue="desktop-games" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="fixed top-0 left-0 right-0 z-50 px-4 py-2">
          {isCyberpunk ? (
            <CyberTabsList className="w-full max-w-6xl mx-auto grid grid-cols-4 p-0 h-auto">
              <CyberTabsTrigger
                value="exchange"
                data-value="EXCHANGE"
                onClick={() => {
            ...
            <TabsList className="mb-0 border-2 border-black bg-[#FFD54F] dark:bg-[#D4AF37] dark:border-gray-700 w-full max-w-6xl mx-auto grid grid-cols-4 p-0 h-auto">
              <TabsTrigger
                value="exchange"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    >
                      <h3
                        className={cn(
                          "font-bold mb-2 font-mono text-lg dark:text-white",
                          isCyberpunk && "text-cyan-400",
                        )}
                      >
                    ...
                    >
                      ...
                      <ul className={cn("space-y-2 text-sm dark:text-gray-300", isCyberpunk && "text-cyan-300/70")}>
                        <li className="flex items-start gap-2">
                          <AlertCircle
                            className={cn(
                              "h-4 w-4 text-amber-600 mt-0.5 flex-shrink-0",
